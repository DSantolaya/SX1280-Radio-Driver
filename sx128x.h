...
#else
#define SX128X_SPI_CS_PORT GPIO_A_NUM //B      
#endif
...
#else 
#define SX128X_LORA_INIT_BW RADIO_BW_400
#endif
...
#define SX128X_CRYSTAL_FREQ (52.0)                                 /**Crystal oscillator freq 52MHz**/
...
#define SX128X_RADIO_TX_POWER            (-5)                  /**< Radio power in dBm  -18dBm to 13dBm*/
...
typedef struct {
    ...
    gpio_hal_pin_t dio2_pin;           /**< Interrupt line DIO2 (FHSS channel change) FHSS Frecuency Hopping Spread Spectrum*/
